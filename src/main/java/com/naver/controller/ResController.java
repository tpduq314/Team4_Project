...
public class ResController {
	...
	public String travel_reservation(HttpServletResponse response,HttpSession session,@RequestParam("res_code") String res_code,@RequestParam("pack_code") String pack_code,Model m,@ModelAttribute ResVO r,@ModelAttribute PackVO p)throws Exception {
	...
	public String travel_reservation_ok(HttpServletResponse response,HttpSession session,@ModelAttribute ResVO r,@ModelAttribute PackVO p,Model m,@ModelAttribute CliVO c) throws Exception {
	...
	public String customer_service_ok(@ModelAttribute QaVO q, HttpServletResponse response, HttpSession session) throws Exception {
	...
	public ModelAndView  mypage(HttpSession session,@ModelAttribute QaVO q,@ModelAttribute ResVO r,HttpServletResponse response) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out=response.getWriter();
