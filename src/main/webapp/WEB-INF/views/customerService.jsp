...
<div id="customer_service">
	...
	<form method="post" action="customer_service_ok">
	<div>
		<!-- <p
		...
		<table
			...
			<tr>
				...
				<td class="cs_tb_2"><input name="qa_phone" id="qa_phone" class="cs_tb_2_input"
			...
			<tr>
				...
				<td class="cs_tb_2"><input name="res_code" id="res_code" class="cs_tb_2_input" type="text"
					placeholder="예약번호를 입력하세요" style="width: 700px;" /></td>
			</tr>
			<tr>
				<td class="cs_tb_1"><span style="color: red;">* </span>제목</td>
				<td class="cs_tb_2"><input name="qa_title" id="qa_title" class="cs_tb_2_input"
					type="text" placeholder="제목을 입력하세요"
					style="width: 700px; height: 40px;" /></td>
			</tr>
			<tr>
				<td class="cs_tb_1"><span style="color: red;">* </span>내용</td>
				<td class="cs_tb_2"><input name="qa_cont" id="qa_cont" class="cs_tb_2_input"
		...
		<button
			onclick="ask(document.getElementById('qa_phone'),document.getElementById('qa_title'),document.getElementById('qa_cont'))"
