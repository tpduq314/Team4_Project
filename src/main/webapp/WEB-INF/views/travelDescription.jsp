...
<script>
	...
	function calc() {
		...
		document.getElementById("res_total_price").innerHTML = totalPrice;
	}
</script>
<body>
	<div id="header">
		...
		<form name="res" method="post" action="res">
			<div id="des_top">
				...
				<div id="product_code">
					...
					<div id="pack_code">${p.pack_code}</div>
				</div>
			</div>
			...
			<div id="reservation_form" >
				...
				<div class="rf">
					2. 항공 선택 <br> <select class="select_option">
						<option>진에어</option>
						<option>대한항공</option>
						<option>아시아나</option>
					</select>
				...
				<div class="rf">
					3.호텔 선택 <br> <select class="select_option">
						<option>괌 PIC</option>
					</select>
				</div>
				<div class="rf" style="">
				...
				<input type="submit" id="btn_reservation" value="예약하기" />
